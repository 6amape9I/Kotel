...
class UpRecurs {
    ...
    fun countLess3(n:Int):Int = digitsRec(n, 0, {k:Int -> k == 0}, {k:Int, m:Int -> if(k<3) m+1 else m})
...
fun main() {
    val upRecurs = UpRecurs()
    println(upRecurs.minDigit(991234789))
    println(upRecurs.countLess3(991234789))
    println(upRecurs.countDividers(16))
}